...
#cutadapt
system(command = 'cutadapt -a AGATCGGAAGAG -A AGATCGGAAGAG -q 20 -m 10 --pair-filter=any -o /home/willettb/bulk-rnaseq-gallagher/fastq_trimmed/*1_trimmed.fastq.gz -p /home/willettb/bulk-rnaseq-gallagher/fastq_trimmed/*2_trimmed.fastq.gz /home/willettb/bulk-rnaseq-gallagher/fastq_raw/*1.fastq.gz /home/willettb/bulk-rnaseq-gallagher/fastq_raw/*2.fastq.gz')
...
#for loop for unstimulated samples. Trial run for making for loop for all files I need to trim
...
#ok looks good - gives me this, and loops over the rest too.
#/home/willettb/bulk-rnaseq-gallagher/fastq_trimmed/0_min_unstimulated_rep1_1_trimmed.fastq.gz
...
#screw it. brute forcing the unstimulated samples. 
...
#QC of quantification with Picard
...
#get info from rna metrics for strandedness
#can automate later..
...
#metadata labeled and uploaded (gallagher_metadata.csv)
...
#overRep analysis C7 immunological gene sets
...
#grepl command doesn't get all of the data/attributes I need for dotplot
typeof(Tcell_pathways_up)
typeof(outputC7_up)

class(Tcell_pathways_up)
class(outputC7_up)

sapply(Tcell_pathways_up, class)
sapply(outputC7_up, class)
